...
| 2026-07-09 | Phase 0 | 串接上傳草稿人工查核     | 建議將地點線索改成按鈕選項，並讓上傳草稿可送到工作人員頁的待查核清單                                               | 採用        | 減少真實地址輸入風險；送交人工查核仍是前端暫存流程，不代表正式收案或已確認       | `src/app/App.tsx`, `src/features/phase-0/Phase0UploadPage.tsx`, `src/features/phase-0/Phase0Workbench.tsx`, `tests/app-smoke.test.tsx`          |
